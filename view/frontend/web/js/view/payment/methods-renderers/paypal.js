    ...
    return Component.extend({
        ...
        reInitPayPal: function () {
            ...
            if (!quote.isVirtual()) {
                ...
                this.clientConfig.paypal.shippingAddressOverride = false;
            }
        ...
        getPayPalConfig: function () {
            ...
            if (!quote.isVirtual()) {
                ...
                config.paypal.shippingAddressOverride = false;
            }
        ...
        getShippingAddress: function () {
            ...
            return {
                ...
                state: _.isUndefined(address.regionCode) ? '' : address.regionCode
            };
        },
